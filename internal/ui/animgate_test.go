...
var hidingStates = []struct {
	...
	{"text-popup", func(m *Model) { m.openTextPopup("Stats", "one\ntwo") }},
	{"template-picker", func(m *Model) { m.openTemplatePicker() }},
	...
	{"kaomoji-picker", func(m *Model) { m.openKaomojiPicker() }},
	...
	{"gitlab-confirm", func(m *Model) { m.refConfirm.active = true }},
